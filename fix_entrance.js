...
// Replace cream colors with black/gold
content = content.replaceAll('#fcf3c6', '#050505');
content = content.replaceAll('#311059', '#D4AF37'); // Replace dark purple with gold for text/borders

// Replace Capability Sign Banners
content = content.replace('\"Creative Dev\"', '\"Space Planning\"');
content = content.replace('\"Frontend Eng\"', '\"Custom Millwork\"');
content = content.replace('\"Full Stack\"', '\"Architecture\"');
content = content.replace('\"3D & Motion\"', '\"3D Rendering\"');

// Replace left door stickers
