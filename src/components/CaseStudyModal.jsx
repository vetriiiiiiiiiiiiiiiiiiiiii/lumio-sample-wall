  ...
  return (
    <div
      ...
      style={{
        ...
        pointerEvents: 'none',
        overflowY: 'auto',
        padding: 'clamp(12px, 3vw, 40px) clamp(10px, 3vw, 24px)',
        display: 'flex',
    ...
    >
      ...
      >
        ...
        {/* Hero Image */}
        <div style={{ width: '100%', height: 'clamp(200px, 35vh, 350px)', position: 'relative', overflow: 'hidden' }}>
          <img
            src={project.image}
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            <div>
              <h2 style={{ fontSize: '1.4rem', marginBottom: '12px', color: 'var(--text-primary)' }}>Overview</h2>
            ...
            <div>
              <h2 style={{ fontSize: '1.4rem', marginBottom: '12px', color: 'var(--text-primary)' }}>Challenge</h2>
              <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem', lineHeight: 1.7 }}>
            ...
            <div>
              <h2 style={{ fontSize: '1.4rem', marginBottom: '12px', color: 'var(--text-primary)' }}>Solution</h2>
              <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem', lineHeight: 1.7 }}>
            ...
            {project.caseStudy.keyFeatures && (
              <div>
                <h2 style={{ fontSize: '1.4rem', marginBottom: '12px', color: 'var(--text-primary)' }}>Key Features</h2>
                <ul style={{ color: 'var(--text-secondary)', fontSize: '1rem', lineHeight: 1.7, paddingLeft: '20px', margin: 0 }}>
          ...
          >
            <div>
              <h3 style={{ fontSize: '1rem', color: 'var(--text-primary)', marginBottom: '12px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                Technology
              </h3>
            ...
            {project.caseStudy.performance && (
              <div>
                <h3 style={{ fontSize: '1rem', color: 'var(--text-primary)', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                  Performance
                </h3>
            ...
            <div>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: 1.6, margin: 0 }}>
                {project.caseStudy.results || project.caseStudy.outcome}
              </p>
            </div>
          </div>
        </div>
